...
let Pt = class Ze extends S {
  ...
  child(e) {
    return this.childPopup && this.childPopup.hide(), this.childPopup = new Ze(this.table, e, this), this.childPopup;
  }
};
class w extends S {
  constructor(e, t) {
...
b(ie, "moduleName", "accessor"), //load defaults
b(ie, "accessors", At);
let ye = ie;
var _t = {
  method: "GET"
...
function et(l, e, t) {
  return l && t && Object.keys(t).length && (!e.method || e.method.toLowerCase() == "get") && (e.method = "get", l += (l.includes("?") ? "&" : "?") + Bt(t)), l;
}
function Vt(l, e, t) {
  var i;
...
b(_, "moduleName", "ajax"), //load defaults
b(_, "defaultConfig", _t), b(_, "defaultURLGenerator", et), b(_, "defaultLoaderPromise", Vt), b(_, "contentTypeFormatters", It);
let xe = _;
var Nt = {
  replace: function(l) {
...
`);
  ...
  setPasteAction(e) {
    switch (typeof e) {
      case "string":
        this.pasteAction = G.pasteActions[e], this.pasteAction || console.warn("Clipboard Error - No such paste action found:", e);
        break;
      case "function":
        this.pasteAction = e;
        break;
  ...
  setPasteParser(e) {
    switch (typeof e) {
      case "string":
        this.pasteParser = G.pasteParsers[e], this.pasteParser || console.warn("Clipboard Error - No such paste parser found:", e);
        break;
      case "function":
        this.pasteParser = e;
        break;
...
b(G, "moduleName", "clipboard"), b(G, "moduleExtensions", Ut), //load defaults
b(G, "pasteActions", Nt), b(G, "pasteParsers", Wt);
let Te = G;
class Xt {
  constructor(e) {
...
class fe extends S {
  ...
  //////////////// Object Generation /////////////////
  getComponent() {
    return this.component || (this.component = new tt(this)), this.component;
  }
}
class it {
  constructor(e) {
...
const j = class j extends w {
  ...
  generateRow(e, t) {
    ...
    return this.table.modExists("mutator") && this.table.modules.mutator.disable(), s = new z(i, this, "calc"), this.table.modExists("mutator") && this.table.modules.mutator.enable(), s.getElement().classList.add("tabulator-calcs", "tabulator-calcs-" + e), s.component = !1, s.getComponent = () => (s.component || (s.component = new Xt(s)), s.component), s.generateCells = () => {
      var n = [];
...
b(j, "moduleName", "columnCalcs"), //load defaults
b(j, "calculations", Jt);
let ke = j;
class nt extends w {
  constructor(e) {
...
const se = class se extends w {
  ...
  download(e, t, i, s, n) {
    ...
    if (typeof e == "function" ? r = e : se.downloaders[e] ? r = se.downloaders[e] : console.warn("Download Error - No such download type found: ", e), r) {
...
let li = class {
  ...
  _ajaxRequest(e, t) {
    ...
    return e = et(e, {}, i), fetch(e).then((s) => s.ok ? s.json().catch((n) => (console.warn("List Ajax Load Error - Invalid JSON returned", n), Promise.reject(n))) : (console.error("List Ajax Load Error - Connection Error: " + s.status, s.statusText), Promise.reject(s))).catch((s) => (console.error("List Ajax Load Error - Connection Error: ", s), Promise.reject(s)));
  }
...
function hi(l, e, t, i, s) {
  var n = new li(this, l, e, t, i, s);
  return n.input;
}
...
b(le, "moduleName", "edit"), //load defaults
b(le, "editors", pi);
let Le = le;
class $e {
  constructor(e, t, i, s) {
...
const U = class U extends w {
  ...
  generateExportList(e, t, i, s) {
    var n, r, o, a;
    return this.cloneTableStyle = t, this.config = e || {}, this.colVisProp = s, this.colVisPropAttach = this.colVisProp.charAt(0).toUpperCase() + this.colVisProp.slice(1), a = U.columnLookups[i], a && (o = a.call(this.table), o = o.filter((h) => this.columnVisCheck(h))), n = this.config.columnHeaders !== !1 ? this.headersToExportRows(this.generateColumnGroupHeaders(o)) : [], o && (o = o.map((h) => h.getComponent())), r = this.bodyToExportRows(this.rowLookup(i), o), n.concat(r);
  }
  ...
  rowLookup(e) {
    ...
    }) : (i = U.rowLookups[e] || U.rowLookups.active, t = i.call(this.table)), Object.assign([], t);
  }
  ...
  bodyToExportRows(e, t = []) {
    ...
    return t.length === 0 && this.table.columnManager.columnsByIndex.forEach((s) => {
      ...
      i.push(new $e(s.type, o, s.getComponent(), a));
    }), i;
  }
...
b(U, "moduleName", "export"), b(U, "columnLookups", mi), b(U, "rowLookups", gi);
let Se = U;
var bi = {
  //equal to
  "=": function(l, e, t, i) {
...
const X = class X extends w {
  ...
  lookupFormatter(e) {
    ...
    switch (typeof e) {
      case "string":
        X.formatters[e] ? t = X.formatters[e] : (console.warn("Formatter Error - No such formatter found: ", e), t = X.formatters.plaintext);
        break;
      case "function":
        t = e;
        break;
      default:
        t = X.formatters.plaintext;
        break;
    }
    return t;
  }
...
b(X, "moduleName", "format"), //load defaults
b(X, "formatters", Ii);
let ze = X;
class rt extends w {
  constructor(e) {
...
b(J, "moduleName", "history"), b(J, "moduleExtensions", Xi), //load defaults
b(J, "undoers", Wi), b(J, "redoers", Gi);
let Fe = J;
class lt extends w {
  constructor(e) {
...
b(lt, "moduleName", "htmlTableImport");
function Ji(l) {
  var e = [], t = 0, i = 0, s = !1;
...
const he = class he extends w {
  ...
  lookupImporter(e) {
    var t;
    return e || (e = this.table.options.importFormat), typeof e == "string" ? t = he.importers[e] : t = e, t || console.error("Import Error - Importer not found:", e), t;
  }
...
b(he, "moduleName", "import"), //load defaults
b(he, "importers", Yi);
let He = he;
class ht extends w {
  constructor(e) {
  ...
  dispatchEvent(e, t, i) {
    ...
    this.columnSubscribers[e] && (i instanceof fe ? n = i.column.definition[e] : i instanceof Q && (n = i.definition[e]), n && n(t, s)), this.dispatchExternal(e, t, s);
  }
}
b(ht, "moduleName", "interaction");
var Qi = {
  navPrev: "shift + 9",
  navNext: 9,
  navUp: 38,
...
const K = class K extends w {
  ...
  initialize() {
    ...
    this.watchKeys = {}, this.pressedKeys = [], e !== !1 && (Object.assign(t, K.bindings), Object.assign(t, e), this.mapBindings(t), this.bindEvents()), this.subscribe("table-destroy", this.clearBindings.bind(this));
  }
  mapBindings(e) {
    for (let t in e)
      K.actions[t] ? e[t] && (typeof e[t] != "object" && (e[t] = [e[t]]), e[t].forEach((i) => {
...
b(K, "moduleName", "keybindings"), //load defaults
b(K, "bindings", Qi), b(K, "actions", Zi);
let Oe = K;
class dt extends w {
  constructor(e) {
...
const $ = class $ extends w {
  ...
  dropComplete(e, t, i) {
    ...
    if (i) {
      switch (typeof this.table.options.movableRowsSender) {
        case "string":
          s = $.senders[this.table.options.movableRowsSender];
          break;
        case "function":
  ...
  tableRowDrop(e, t) {
    ...
    switch (e.stopImmediatePropagation(), typeof this.table.options.movableRowsReceiver) {
      case "string":
        i = $.receivers[this.table.options.movableRowsReceiver];
        break;
      case "function":
...
b($, "moduleName", "moveRow"), //load defaults
b($, "senders", es), b($, "receivers", ts);
let Pe = $;
var is = {};
...
b(ne, "moduleName", "mutator"), //load defaults
b(ne, "mutators", is);
let Ae = ne;
...
const de = class de extends w {
  ...
  initializePageCounter() {
    ...
    e && (typeof e == "function" ? t = e : t = de.pageCounters[e], t ? (this.pageCounter = t, this.pageCounterElement = document.createElement("span"), this.pageCounterElement.classList.add("tabulator-page-counter")) : console.warn("Pagination Error - No such page counter found: ", e));
  }
  //setup pagination
...
b(de, "moduleName", "page"), //load defaults
b(de, "pageCounters", rs);
let _e = de;
var os = {
  local: function(l, e) {
...
b(Ve, "moduleName", "responsiveLayout"), b(Ve, "moduleExtensions", hs);
function ds(l, e, t) {
...
b(Ie, "moduleName", "selectRow"), b(Ie, "moduleExtensions", us);
class cs {
  constructor(e) {
...
class pe extends w {
  ...
  addRange(e, t) {
    var i;
    return this.maxRanges !== !0 && this.ranges.length >= this.maxRanges && this.ranges.shift().destroy(), i = new fs(this.table, this, e, t), this.activeRange = i, this.ranges.push(i), this.rangeContainer.appendChild(i.element), i;
  }
  resetRanges() {
    var e, t, i;
...
const Y = class Y extends w {
  ...
  initializeColumn(e) {
    ...
    switch (typeof e.definition.sorter) {
      case "string":
        Y.sorters[e.definition.sorter] ? t = Y.sorters[e.definition.sorter] : console.warn("Sort Error - No such sorter found: ", e.definition.sorter);
        break;
      case "function":
...
b(Y, "moduleName", "sort"), //load defaults
b(Y, "sorters", Ss);
let Ne = Y;
class Ds {
  constructor(e, t) {
...
Data:     `, e), !1;
  ...
  newSheet(e = {}) {
    var t;
    return e.rows || (e.rows = this.options("spreadsheetRows")), e.columns || (e.columns = this.options("spreadsheetColumns")), t = new Ye(this, e), this.sheets.push(t), this.element && this.element.appendChild(t.element), t;
  }
  removeSheet(e) {
  ...
  lookupSheet(e) {
    return e ? e instanceof Ye ? e : e instanceof vt ? e._sheet : this.sheets.find((t) => t.key === e) || !1 : this.activeSheet;
  }
  ///////////////////////////////////
  //////// Public Functions /////////
  ///////////////////////////////////
...
b(ue, "moduleName", "validate"), //load defaults
b(ue, "validators", zs);
let We = ue;
var Ce = /* @__PURE__ */ Object.freeze({
  ...
  KeybindingsModule: Oe,
  MenuModule: dt,
  MoveColumnsModule: ut,
  MoveRowsModule: Pe,
  MutatorModule: Ae,
  PageModule: _e,
  PersistenceModule: Be,
  PopupModule: ct,
  PrintModule: ft,
  ReactiveDataModule: pt,
...
class Ps extends S {
  constructor(e) {
    super(e), this.blockHozScrollEvent = !1, this.headersElement = null, this.contentsElement = null, this.rowHeader = null, this.element = null, this.columns = [], this.columnsByIndex = [], this.columnsByField = {}, this.scrollLeft = 0, this.optionsList = new yt(this.table, "column definition", st), this.redrawBlock = !1, this.redrawBlockUpdate = null, this.renderer = null;
  }
  ////////////// Setup Functions /////////////////
  initialize() {
  ...
  setColumns(e, t) {
    ...
    this.columns = [], this.columnsByIndex = [], this.columnsByField = {}, this.dispatch("columns-loading"), this.dispatchExternal("columnsLoading"), this.table.options.rowHeader && (this.rowHeader = new Q(this.table.options.rowHeader === !0 ? {} : this.table.options.rowHeader, this, !0), this.columns.push(this.rowHeader), this.headersElement.appendChild(this.rowHeader.getElement()), this.rowHeader.columnRendered()), e.forEach((i, s) => {
      this._addColumn(i);
  ...
  _addColumn(e, t, i) {
    var s = new Q(e, this), n = s.getElement(), r = i && this.findColumnIndex(i);
...
const re = class re extends w {
  ...
  initialize() {
    ...
    re.modes[e] ? this.mode = e : (console.warn("Layout Error - invalid mode set, defaulting to 'fitData' : " + e), this.mode = "fitData"), this.table.element.setAttribute("tabulator-layout", this.mode), this.subscribe("column-init", this.initializeColumn.bind(this));
  }
  initializeColumn(e) {
  ...
  layout(e) {
    ...
    this.dispatch("layout-refreshing"), re.modes[this.mode].call(this, this.table.columnManager.columnsByIndex, e), t && this.table.rowManager.normalizeHeight(!0), this.dispatch("layout-refreshed");
  }
};
b(re, "moduleName", "layout"), //load defaults
b(re, "modes", $s);
let Ge = re;
var Ys = {
  default: {
...
const ce = class ce extends w {
  ...
  initialize() {
    this.langList = M.deepClone(ce.langs), this.table.options.columnDefaults.headerFilterPlaceholder !== !1 && this.setHeaderFilterPlaceholder(this.table.options.columnDefaults.headerFilterPlaceholder);
...
const T = class T extends Ue {
  ...
  static initializeModuleBinder(e) {
    T.modulesRegistered || (T.modulesRegistered = !0, T._registerModules(Qs, !0), e && T._registerModules(e));
  }
...
const V = class V extends Xe {
  ...
  initializeCoreSystems(e) {
    this.columnManager = new Ps(this), this.rowManager = new Bs(this), this.footerManager = new Vs(this), this.dataLoader = new Ws(this), this.alertManager = new Zs(this), this._bindModules(), this.options = this.optionsList.generate(V.defaultOptions, e), this._clearObjectPointers(), this._mapDeprecatedFunctionality(), this.externalEvents = new Gs(this, this.options, this.options.debugEventsExternal), this.eventBus = new js(this.options.debugEventsInternal), this.interactionMonitor = new Is(this), this.dataLoader.initialize(), this.footerManager.initialize(), this.dependencyRegistry.initialize();
  }
...
b(V, "defaultOptions", Fs);
let Je = V;
var ae = Je;
class en extends ae {
  static extendModule() {
    ae.initializeModuleBinder(Ce), ae._extendModule(...arguments);
  }
  static registerModule() {
    ae.initializeModuleBinder(Ce), ae._registerModule(...arguments);
  }
  constructor(e, t, i) {
    super(e, t, Ce);
  }
...
var tn = en;
function sn(l) {
  const e = I([]), t = I(!1), i = I(null), s = I(0);
  return {
    documents: e,
    isLoading: t,
    error: i,
    uploadProgress: s,
    fetchDocuments: async (d, u) => {
      t.value = !0, i.value = null;
      try {
        let c = l.schema("hf").from("documents").select("*").eq("symbol_root", d).order("uploaded_at", { ascending: !1 });
        u && (c = c.eq("user_id", u));
        const { data: f, error: p } = await c;
        if (p) throw p;
        e.value = f || [];
      } catch (c) {
        i.value = c instanceof Error ? c.message : "Failed to fetch documents", console.error("Error fetching documents:", c);
      } finally {
        t.value = !1;
      }
    },
    uploadDocument: async (d, u, c, f) => {
      t.value = !0, i.value = null, s.value = 0;
      try {
        const p = Date.now(), g = d.name.replace(/[^a-zA-Z0-9.-]/g, "_"), v = `${u}/${c}/${p}_${g}`, { error: m } = await l.storage.from("documents").upload(v, d, {
          cacheControl: "3600",
          upsert: !1
        });
        if (m) throw m;
    ...
    downloadDocument: async (d) => {
      try {
        const { data: u, error: c } = await l.storage.from("documents").download(d.storage_path);
        if (c) throw c;
        const f = URL.createObjectURL(u), p = window.document.createElement("a");
        p.href = f, p.download = d.file_name, p.click(), URL.revokeObjectURL(f);
      } catch (u) {
        i.value = u instanceof Error ? u.message : "Failed to download document", console.error("Error downloading document:", u);
      }
    },
    deleteDocument: async (d) => {
      t.value = !0, i.value = null;
      try {
        const { error: u } = await l.storage.from("documents").remove([d.storage_path]);
        if (u) throw u;
        const { error: c } = await l.schema("hf").from("documents").delete().eq("id", d.id);
        if (c) throw c;
        e.value = e.value.filter((f) => f.id !== d.id);
      } catch (u) {
        throw i.value = u instanceof Error ? u.message : "Failed to delete document", console.error("Error deleting document:", u), u;
      } finally {
        t.value = !1;
      }
    },
    formatFileSize: (d) => {
      ...
      const u = 1024, c = ["Bytes", "KB", "MB", "GB"], f = Math.floor(Math.log(d) / Math.log(u));
      return Math.round(d / Math.pow(u, f) * 100) / 100 + " " + c[f];
    }
  };
}
const nn = { class: "documents-view" }, rn = {
  ...
  setup(l) {
    ...
    const C = (E) => [
      ...
      },*/
      {
        ...
        formatter: (E) => {
          ...
          return `
        ${C(R.file_type) ? '<button class="btn-view" title="View"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg></button>' : ""}
      ...
      if (!(!g.value || !e.userId))
        try {
          await a(
            ...
            e.userId,
            p.value || void 0
          ), g.value = null, p.value = "", v.value = !1, f.value && (f.value.value = "");
        } catch {
        }
    }, N = () => {
      v.value = !0;
    ...
    return kt(async () => {
      await o(e.symbolRoot, e.userId || void 0), await Mt(), c.value && (m = new tn(c.value, {
        data: i.value,
        columns: L,
        layout: "fitColumns",
        //height: '500px',
